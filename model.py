...
class GPT(nn.Module):
    def __init__(self, config):
        ...
        self.transformer = nn.ModuleDict(dict(
            wve=nn.Linear(config.input_vector_size, config.n_embd, bias=config.bias),
    ...
    def forward(self, idx, targets=None):
        ...
        vector_emb = self.transformer.wve(idx)  # vector embeddings of shape (b, t, n_embd)
        x = self.transformer.drop(vector_emb + pos_emb)
