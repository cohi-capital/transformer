...
def generate_pkl(data_type='train'):
    train_data = f'train_balance0{int(TARGET_POS_SAMPLE_RATIO * 10)}_decay0{int(WEEKLY_DECAY * 10)}_block{BLOCK_SIZE}.pkl'
    validation_data = f'val_block{BLOCK_SIZE}.pkl'
    metadata = f'meta_{data_type}_balance0{int(TARGET_POS_SAMPLE_RATIO * 10)}_decay0{int(WEEKLY_DECAY * 10)}_block{BLOCK_SIZE}.pkl'
